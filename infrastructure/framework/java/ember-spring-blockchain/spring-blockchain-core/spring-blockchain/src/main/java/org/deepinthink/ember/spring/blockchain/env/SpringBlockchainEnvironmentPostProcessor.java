 ...
 */
package org.deepinthink.ember.spring.blockchain.env;

import java.util.Properties;
import org.deepinthink.ember.spring.blockchain.SpringBlockchainVersion;
...
public class SpringBlockchainEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
  ...
  public static final String SPRING_BLOCKCHAIN_DEFAULT_PROPERTY_SOURCE =
      "ember.spring-blockchain.default-properties";
  public static final String SPRING_BLOCKCHAIN_VERSION = "ember.spring-blockchain.version";
  public static final String SPRING_BLOCKCHAIN_FORMATTED_VERSION =
      "ember.spring-blockchain.formatted-version";
